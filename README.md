...
**Important:** Be sure to push your codebase to the default branch in GitHub -- NOT your built and deployed code. Ensure this happens by using the enough to read and that the colors don't cause eye strain.
`gh-pages` branch to host the deployed application's build.
...
* Ensure that the font size is large 
